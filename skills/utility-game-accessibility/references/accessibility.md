# Mobile Game Accessibility Reference

All methodology, standards, React Native patterns, and platform-specific
implementation for utility-game-accessibility. Loaded on demand.

---

## TOC

1. Part 1 — Prevalence and Scope
2. Part 2 — Visual Accessibility
3. Part 3 — Motor Accessibility
4. Part 4 — Cognitive Accessibility
5. Part 5 — Hearing Accessibility
6. Part 6 — Vestibular and Photosensitive Accessibility
7. Part 7 — Settings Screen Requirements
8. Part 8 — Accessibility Audit Checklist
